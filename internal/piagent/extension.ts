...
export default function galpon(pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		description: "Use only for contact that the user explicitly requested, including necessary follow-ups within that requested scope. Queue a typed durable message for another Galpón agent and start that agent if necessary. request and query require a reply. inform is one-way coordination and does not send the target's final reply back. Returns a message ID immediately. Do not use this tool to return the result of a delivery that you are processing; put that complete result in your final assistant response.",
		parameters: Type.Object({
